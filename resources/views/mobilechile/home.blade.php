  ...
  <body>
      @if((session()->has("flash")))
        <div class="alert alert-success">
          <span class="white-text">{{session("flash")}}</span>
        </div>
      @endif
        ...
        <div class="col s12 m10 offset-m1 column-wrapper">
          <div class="column-two">
            ...
            <div class="phone-preview-sizer">
              ...
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_1-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
                <div class="phone-preview"></div>
                <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_2-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_3-min.png)"></div>
            </div>
          </div>
          <div class="column-one">
                <div class="phone-preview-sizer">
                    <div class="phone-preview"></div>
                    <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_4-min.png)"></div>
                </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_5-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_6-min.png)"></div>
            </div>
          </div>
          <div class="column-two">
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_7-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_8-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_9-min.png)"></div>
            </div>
          </div>
          <div class="column-one">
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_11-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_10-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_12-min.png)"></div>
            </div>
          </div>
          <div class="column-two">
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_13-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_14-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_15-min.png)"></div>
            </div>
          </div>
          <div class="column-one">
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/Screenshot_16-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
                    <div class="phone-preview"></div>
            ...
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/1-min.png"></div>
            </div>
          </div>
          <div class="column-two">
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/2-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/3-min.png)"></div>
            </div>
            <div class="phone-preview-sizer">
              <div class="phone-preview"></div>
              <div class="image-container default" style="background-image:url({{ URL::to('/images') }}/5-min.png)"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col s12 m6 l4">
              ...
              <p class="caption">Vendemos servicios, no productos. No cobramos por implementación, y si no te sientes conforme con el servicio, simplemente puedes dejar de pagar. Sin compromisos.</p>
            </div>
            <div class="col s12 m6 l4">
            ...
            <div class="col s12 m4">
              <div class="pricing-table">
                ...
                <ul class="pricing-features">
                  <li class="pricing-feature"><i class="icon-accept"></i>Creación rápida de módulos nativos</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Control de calidad y buenas prácticas en la programación</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Automatización de documentación con fotografías in-situ</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Automatización de procesos con GPS</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Publicación de la aplicación en AppStore y PlayStore</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Sistemas de push notification</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Uso de funcionalidades propias del sistema android y iOS</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Gestión de permisos de acceso al smartphone</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Manejo del Hardware de cada dispositivos</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Manejo de compatibilidad entre dispositivos</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Experto en funcionamiento asincrónico</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Sistemas de geolocalización</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Sistemas de autenticación</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Sistemas de administración y gestión en tiempo real</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Experto en obtención de información e interacción con el usuario</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Experto en integración ágil de contenido móvil</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Manejo en las tendencias del diseño móvil</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Desarrollo de sistemas personalizados</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Integración con redes sociales</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Visualización de Notificaciones</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Despliegue de elementos interactivos</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Consumo de APIs para obtención de información. </li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Manejo de bases de datos locales</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Pagos online</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Delivery</li>
            ...
            <div class="col s12 m4">
              <div class="pricing-table">
                ...
                <ul class="pricing-features">
                  ...
                  <li class="pricing-feature"><i class="icon-accept"></i>Sistemas de notificación</li>
                  <li class="pricing-feature"><i class="icon-accept"></i>Inteligencia artificial y redes neuronales</li>
